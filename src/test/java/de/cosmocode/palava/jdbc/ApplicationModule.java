...
public final class ApplicationModule implements Module {
    ...
    public void configure(Binder binder) {
        ...
        binder.install(JdbcServiceModule.named("hsqldb").overrideOptionals());
        binder.install(JdbcServiceModule.named("h2"));
        binder.install(JdbcServiceModule.named("derby").overrideOptionals());
        binder.install(JdbcServiceModule.named("axion"));
    }
